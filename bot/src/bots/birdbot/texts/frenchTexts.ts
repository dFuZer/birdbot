...
export const frenchTexts = {
    ...
    command: {
        ...
        picture: { description: "Copie ta photo de profil jklm.fun actuelle sur BirdBot pour les salons que tu crées." },
        ...
        parity: {
            ...
            pictureCopied: "La photo de profil de votre BirdBot a été changée!",
            pictureUnavailable: "Impossible de lire ta photo de profil jklm.fun actuelle.",
