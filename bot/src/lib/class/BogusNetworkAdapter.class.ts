...
import AbstractNetworkAdapter from "../abstract/AbstractNetworkAdapter.class";
import type {
  BombPartyRuleKey,
  DictionaryId,
  GameMode,
...
export default class BogusNetworkAdapter implements AbstractNetworkAdapter {
  ...
  public getSetRoomAccessModeMessage({
    accessMode,
  }: {
  ...
  public readGetGamerModerationInfoResultData(
    message: Buffer
  ): ReadGetGamerModerationInfoResultData {
    return 0 as any;
  }
  ...
  public readCentralMessageBaseData(
    message: Buffer
  ): ReadCentralMessageBaseData {
    return 0 as any;
  }
  public readOneVOneAnnouncementData(
    message: Buffer
  ): ReadOneVOneAnnouncementData {
    return 0 as any;
  }
  public readUpdatePlaylistRatingsData(
    message: Buffer
  ): ReadUpdatePlaylistRatingsData {
    return 0 as any;
  }
