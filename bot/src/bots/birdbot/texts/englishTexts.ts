...
export const englishTexts = {
    ...
    command: {
        ...
        speedRecords: { description: "Shows global or player API-backed speed milestones." },
        accuracyRecords: { description: "Shows global or player API-backed valid-word streak milestones." },
        credits: { description: "Shows your BirdBot credit balance." },
        economy: { description: "Shows a player's credits, VIP tier, and purchases." },
        buy: { description: "Purchases a VIP SKU with BirdBot credits." },
        ...
        picture: { description: "Sets the BirdBot picture used in rooms you create. Provide an image URL." },
        ...
        admin: {
            ...
            giveCreditsUsage: "Usage: /givecredits [player] [amount]",
            giveCreditsResult: "Adjusted {{player}} by {{amount}} credits. Balance: {{balance}}.",
        ...
        parity: {
            ...
            milestones: "{{player}} — {{type}} milestones: {{records}}",
            noMilestones: "{{player}} has no {{type}} milestones yet.",
            globalMilestones: "Global {{type}} milestones: {{records}}",
            noGlobalMilestones: "No global {{type}} milestones yet.",
            milestoneSpeed: "{{value}}ms",
            milestoneAccuracy: "{{value}} valid words",
            credits: "You have {{count}} credits.",
            economy: "{{player}}: {{credits}} credits — tier {{tier}} — {{purchases}} purchase(s).",
            purchaseLogin: "You must be logged in to make a purchase.",
            availableSkus: "Available SKUs: VIP (500 credits), VIP+ (1000 credits).",
            alreadyVip: "You already have {{tier}}.",
            purchasedVip: "Purchased {{tier}}.",
            ...
            cosmeticTier: "This customization requires {{tier}}.",
    ...
    parity: {
        gameplay: {
            ...
            trainingLogin: "Training requires a logged-in room creator.",
            invalidTrainingRegex: "Invalid or too-expensive training regular expression.",
            tooManyTrainingMatches: "Training matches more than 30000 words.",
            noTrainingMatches: "No training words match.",
            trainingEnabled: "Training enabled; ranked score counting is disabled.",
            trainingDisabled: "Training disabled; score eligibility restored.",
            trainingConfigured: "Training enabled with {{count}} words ({{sort}}); ranked score counting is disabled.",
            humanEnabled: "Human mode enabled; BirdBot will not play and ranked score counting is disabled.",
            humanDisabled: "Human mode disabled; score eligibility restored.",
