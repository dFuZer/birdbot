...
export const frenchTexts = {
    ...
    command: {
        ...
        train: {
            description:
                "Active un mode d'entraînement où tu dois placer un maximum de mots de ta liste d'entraînement. Usage : /train [RegExps...] ou /train [record]",
        },
        searchWords: {
            description:
    ...
    parity: {
        gameplay: {
            ...
            tooManyTrainingMatches: "Erreur : vos paramètres /train ont renvoyé plus de {{max}} résultats. Veuillez utiliser des paramètres plus sélectifs.",
            noTrainingMatches: "Erreur : vos paramètres /train n'ont renvoyé aucun résultat.",
            trainingEnabled: "Mode d'entraînement activé. Vous pouvez désormais utiliser /c en toutes circonstances.",
            trainingDisabled: "Vous ne vous entraînez plus.",
            trainingConfigured: "Votre liste d'entraînement avec {{count}} résultats vient d'être appliquée. Méthode de tri : {{sort}}. Liste : {{list}}.",
            trainingSuccess: "[TRAIN ✅] ({{successes}}/{{attempts}}, {{percentage}}%)",
            trainingFail: "[TRAIN ❌] [{{prompt}}] Vous auriez pu placer : {{suggestions}} ({{successes}}/{{attempts}}, {{percentage}}%)",
            ...
            unrankedReasonCustom: "Mode personnalisé activé",
            unrankedReasonTraining: "Mode d'entraînement activé",
