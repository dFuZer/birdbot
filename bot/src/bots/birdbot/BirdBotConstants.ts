...
export const defaultBirdBotBombPartyRules =
    birdbotRegularModeRules satisfies DictionaryLessGameRules;
...
export const birdbotSupportedDictionaryIds = [
    "fr",
    "en",
    "de",
    "es",
...
export const modesEnumSchema = z.enum([
    "regular",
    "easy",
    "blitz",
    "sub500",
...
export const sortWordsModeRecords = [
    "flips",
    "multi_syllable",
    "depleted_syllables",
