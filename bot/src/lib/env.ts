...
const JKLM_AUTH_EXPIRATION = process.env.JKLM_AUTH_EXPIRATION ? Number(process.env.JKLM_AUTH_EXPIRATION) : 2982251755416;
...
export { JKLM_AUTH_EXPIRATION, JKLM_AUTH_TOKEN, JKLM_AUTH_USERNAME, JKLM_LANGUAGE, JKLM_NICKNAME, JKLM_PICTURE, NAMESPACE_UUID };
