...
export const spanishTexts = {
    ...
    command: {
        ...
        speedRecords: { description: "Muestra los tiempos más rápidos para alcanzar hitos de cada categoría." },
        accuracyRecords: { description: "Muestra el menor número de palabras usado para alcanzar hitos de cada categoría." },
        feathers: { description: "Muestra tu saldo de plumas de BirdBot." },
        economy: { description: "Muestra plumas, estado VIP y compras de un jugador." },
        buy: { description: "Compra VIP con plumas de BirdBot." },
        ...
        playerId: { description: "Muestra el auth id de JKLM, el nombre de perfil y el ID interno de un jugador." },
        ...
        admin: {
            ...
            playerId: "Coincidencia: {{authId}} / {{username}} ({{playerId}})",
            ...
            giveFeathersResult: "Ajustado {{player}} en {{amount}} plumas. Saldo: {{balance}}.",
        ...
        parity: {
            accuracyValue: "{{value}} palabras",
            recordDoesNotExist: "$t(error.intro) La categoría «{{record}}» no existe para este idioma.",
            noRecordsForCategory: "Todavía no hay récords de {{category}}.",
            pageDoesNotExist: "La página de hito {{page}} aún no existe para {{category}}.",
            categoryRecords: "{{category}}, hito {{milestone}} — {{records}}",
            globalRecords: "Récords de {{mode}} — {{records}}",
            noRecordsYet: "Todavía no hay récords de {{mode}}.",
            feathers: "Tienes {{count}} plumas.",
            economy: "{{player}}: {{feathers}} plumas — {{tier}} — {{purchases}} compra(s).",
            purchaseLogin: "Debes iniciar sesión para realizar una compra.",
            availableSkus: "Ofertas disponibles: VIP (500 plumas).",
            alreadyVip: "Ya tienes VIP.",
            purchasedVip: "Has comprado VIP.",
            insufficientFeathers: "No tienes suficientes plumas.",
            ...
            cosmeticTier: "Esta personalización requiere VIP.",
        ...
        playerRecords: {
            description: "Muestra los récords de un jugador para un idioma y modo de juego.",
            noUsernameNotConnected:
                "Debes estar conectado a jklm.fun para ver tus propios récords. Para ver los de otro jugador, usa /pr [nombre de usuario].",
    ...
    eventHandler: {
        ...
        submit: {
            ...
            comments: {
                ...
                reachedMetaMilestone: "ha alcanzado el hito {{milestone}} de {{category}} en velocidad y precisión",
                reachedSpeedMilestone: "ha alcanzado el hito {{milestone}} de {{category}} en velocidad",
                reachedAccuracyMilestone: "ha alcanzado el hito {{milestone}} de {{category}} en precisión",
