...
function TrophyGraphic(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            {...props}
                                ...
                                <div key={i} className="rounded-xl border border-neutral-200 bg-white p-4 text-nowrap">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-neutral-600">
                                                    Level {getLevelFromExperience(x.experience)}
                                                </p>
                                            </div>
                                        </div>
                                        <TrophyGraphic className="size-12" />
                                    </div>
                                    ...
                                    <div className="space-y-1">
                                        <div className="flex items-center justify-between text-sm font-medium text-neutral-600">
                                            ...
                                            <p className="text-xs font-normal">469 / 1250 xp</p>
                                        </div>
                                        <div className="h-2 rounded bg-neutral-100">
                                            <div className="bg-primary-500 h-2 rounded" style={{ width: "50%" }}></div>
                                        </div>
                                    </div>
                                </div>
                            );
